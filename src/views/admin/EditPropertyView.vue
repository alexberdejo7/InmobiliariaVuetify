...
watch(property, (property) => {
    titulo.value.value = property.titulo
    precio.value.value = property.precio
    habitaciones.value.value = property.habitaciones
    wc.value.value = property.wc
    estacionamiento.value.value = property.estacionamiento
    descripcion.value.value = property.descripcion
    alberca.value.value = property.alberca
    center.value = property.ubicacion
})

const submit = handleSubmit(async values => {
  const {imagen, ...property} = values
    if(image.value) {
      const data = {
        ...property,
        imagen: url.value,
